...
// switch1 ///////////////////////////////////////////
  if (switch1CurrentState == 0){
      if(switch1LastState == 1){
          ...
          midiMsg1.msg.channel = 1 + togLState;
          midiMsg1.msg.data1   = 1 + togLState;
...
// switch2 ///////////////////////////////////////////
  if (switch2CurrentState == 0){
      if(switch2LastState == 1){
          ...
          midiMsg2.msg.channel = 2 + togLState;
          midiMsg2.msg.data1   = 2 + togLState;
...
// switch3 ///////////////////////////////////////////
  if (switch3CurrentState == 0){
      if(switch3LastState == 1){
          ...
          midiMsg3.msg.channel = 3 + togLState;
          midiMsg3.msg.data1   = 3 + togLState;
...
// switch4 ///////////////////////////////////////////
  if (switch4CurrentState == 0){
      if(switch4LastState == 1){
          ...
          midiMsg4.msg.channel = 4 + togLState;
          midiMsg4.msg.data1   = 4 + togLState;
